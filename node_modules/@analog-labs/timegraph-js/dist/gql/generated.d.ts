...
export type FeedClockPair = {
    __typename?: 'FeedClockPair';
    feedId: Scalars['Int']['output'];
    lastClock: Scalars['Int']['output'];
};
export type FeedIdLastClockList = {
    __typename?: 'FeedIdLastClockList';
    feedIdLastClockList: Array<FeedClockPair>;
};
...
export type Global = {
    ...
    updatedViews: Array<Scalars['String']['output']>;
    viewCount: Scalars['Int']['output'];
    viewFundLog: Array<ViewFundingLog>;
    viewIndexingStatus: FeedIdLastClockList;
    /**
     * List views and their status based on last clock of feed
     ...
     */
    viewStatus: Array<ViewQueryResult>;
    /**
...
/** Global objects view */
export type GlobalUpdatedViewsArgs = {
    endTime?: InputMaybe<Scalars['String']['input']>;
    startTime?: InputMaybe<Scalars['String']['input']>;
};
/** Global objects view */
...
/** Global objects view */
export type GlobalViewStatusArgs = {
    after?: InputMaybe<Scalars['String']['input']>;
    before?: InputMaybe<Scalars['String']['input']>;
    endTime?: InputMaybe<Scalars['String']['input']>;
    hash?: InputMaybe<Scalars['String']['input']>;
...
export type ViewStatusQueryVariables = Exact<{
    after?: InputMaybe<Scalars['String']['input']>;
    before?: InputMaybe<Scalars['String']['input']>;
    hash?: InputMaybe<Scalars['String']['input']>;
    limit?: InputMaybe<Scalars['Int']['input']>;
...
export type UpdatedViewsQueryVariables = Exact<{
    startTime?: InputMaybe<Scalars['String']['input']>;
    endTime?: InputMaybe<Scalars['String']['input']>;
}>;
export type UpdatedViewsQuery = {
    __typename?: 'Query';
    global: {
        __typename?: 'Global';
        updatedViews: Array<string>;
    };
};
...
export declare const ViewSqlDocument: import("graphql").DocumentNode;
export declare const ViewStatusDocument: import("graphql").DocumentNode;
export declare const UpdatedViewsDocument: import("graphql").DocumentNode;
...
export declare function getSdk(client: GraphQLClient, withWrapper?: SdkFunctionWrapper): {
    ...
    viewSql(variables: ViewSqlQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ViewSqlQuery>;
    viewStatus(variables?: ViewStatusQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ViewStatusQuery>;
    updatedViews(variables?: UpdatedViewsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdatedViewsQuery>;
};
