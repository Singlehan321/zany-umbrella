import { AliasResult, ApiKeyCertifyMutation, ApiKeyInfoFragment, ApiKeyListQuery, BalanceHistoryQuery, DryRunListSmartContractMutation, FunctionCreateMutation, FunctionInfoFragmentFragment, GlobalStatsQuery, ListSmartContractMutation, QueryResult, Sdk, SmartContractGetQuery, SmartContractListFragmentFragment, SponsorViewMutation, SskGraphQuery, SskStatsQuery, TotalContractsQuery, TotalViewsQuery, UpdatedViewsQuery, UserCreateMutation, UserFundedViewsQuery, UserGetQuery, UserGraphQuery, UserListQuery, UserStatsQuery, ViewCreateMutation, ViewDryRunMutation, ViewFundLogQuery, ViewGraphQuery, ViewInfoFragmentFragment, ViewStatsQuery, ViewStatusQuery, WithdrawTokensMutation } from '../gql';
export * from '../gql';
...
export type ViewSql = ViewInfoFragmentFragment['sql'];
...
export type TimegraphApiKey = {
    ...
    certify: SdkRequest<'apiKeyCertify', ApiKeyCertifyMutation['certifyKey']>;
...
export type TimegraphView = {
    ...
    sql: SdkRequest<'viewSql', ViewSql>;
    global: SdkRequest<'viewGlobal', ViewGlobal>;
    subgraph: SdkRequest<'viewSubgraph', ViewSubgraph>;
    status: SdkRequest<'viewStatus', ViewStatusQuery['global']['viewStatus']>;
    updated: SdkRequest<'updatedViews', UpdatedViewsQuery['global']['updatedViews']>;
...
export interface keygenOptionsNode {
    signer: IKeyringPair['sign'] | Signer['signRaw'];
    address: string;
}
...
export declare enum SIGNER_ENV {
    NODE = "node",
    WEB = "web"
}
