...
exports.SmartContractGlobalDocument = (0, graphql_tag_1.default) `
    query smartContractGlobal($address: String, $after: Int, $before: Int, $startTime: String, $endTime: String, $network: String, $limit: Int) {
  global {
    contracts(
      address: $address
      after: $after
...
exports.ViewFundLogDocument = (0, graphql_tag_1.default) `
    query ViewFundLog($viewHash: String!) {
  global {
    viewFundLog(viewHash: $viewHash) {
      view
      sponsor
      status
      timestamp
...
exports.ViewGlobalDocument = (0, graphql_tag_1.default) `
    query viewGlobal($after: String, $before: String, $hash: String, $limit: Int, $startTime: String, $endTime: String) {
  global {
    count {
      views
    }
...
exports.ViewGetDocument = (0, graphql_tag_1.default) `
  ...
  global {
    ...
    ${exports.ViewInfoFragmentFragmentDoc}`;
exports.ViewSqlDocument = (0, graphql_tag_1.default) `
    query viewSql($hashId: String!) {
  global {
    views(hash: $hashId, limit: 1) {
      sql
      hashId
    ...
    `;
exports.ViewStatusDocument = (0, graphql_tag_1.default) `
    query viewStatus($after: String, $before: String, $hash: String, $limit: Int, $startTime: String, $endTime: String) {
  global {
    viewStatus(
      after: $after
      before: $before
    ...
    `;
exports.UpdatedViewsDocument = (0, graphql_tag_1.default) `
    query updatedViews($startTime: String, $endTime: String) {
  global {
    updatedViews(startTime: $startTime, endTime: $endTime)
  }
}
    `;
...
function getSdk(client, withWrapper = defaultWrapper) {
    return {
        ...
        viewSql(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.ViewSqlDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'viewSql', 'query');
        },
        viewStatus(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.ViewStatusDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'viewStatus', 'query');
        },
        updatedViews(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.UpdatedViewsDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'updatedViews', 'query');
        }
    };
}
