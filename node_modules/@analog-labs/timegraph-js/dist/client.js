...
class TimegraphClient {
    ...
    constructor({ url, sessionKey }) {
        ...
        this.smartContract = {
             ...
             */
            get: this.request('smartContractGet', ({ global: { contracts } }) => {
                if (contracts[0]) {
                    return contracts[0];
                }
        ...
        this.view = {
            ...
            /**
             * Fetch a single view by its hash ID, or throw an error if not found
             * @param {g.ViewSqlQueryVariables['hashId']} args.hashId the hash ID of the desired view
             * @returns {types.ViewSql} the retrieved view information
             */
            sql: this.request('viewSql', ({ global: { views } }, variables) => {
                if (views[0] && variables[0] && views[0].hashId === variables[0].hashId) {
                    return views[0].sql;
                }
                throw new ReferenceError('View not found');
            ...
            status: this.request('viewStatus', ({ global: { viewStatus } }) => viewStatus),
            /**
             * Fetch several views from the timegraph at once
             * @param {g.UpdatedViewsQueryVariables['startTime']} args.startTime fetch only views updated after endTime
             * @param {g.UpdatedViewsQueryVariables['endTime']} args.endTime fetch only views updated before endTime
             * @returns {types.string} an array of string views
             */
            updated: this.request('updatedViews', ({ global: { updatedViews } }) => updatedViews),
            /**
             ...
             */
            data: (_a) => __awaiter(this, [_a], void 0, function* ({ hashId, fields, limit = 10 }) {
        ...
        this.raw = {
            ...
            view: {
                ...
                sql: this.request('viewSql', IDENTITY),
